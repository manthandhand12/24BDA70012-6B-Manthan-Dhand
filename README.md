...
A beginner-friendly authentication API built using Node.js, Express, and MongoDB. This project demonstrates user registration, login, JWT authentication, password hashing, and middleware usage.
